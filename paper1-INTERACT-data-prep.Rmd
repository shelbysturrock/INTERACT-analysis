...
# 3. person days where wearing == 1 & in_city == 1
  sd_wearingCity<-merge(sd_wearingCity,weather,by=c("date","city_id"),all.x=TRUE)
  rm(weather)
```
...
```{r}
  write.csv(sd_all,"sensdoc-all-2023.csv",row.names = FALSE)
  write.csv(sd_wearingCity,"sensdoc-wearingCity-2023.csv",row.names = FALSE)
  write.csv(sd_wearing,"sensdoc-wearing-2023.csv",row.names = FALSE)
```
