...
```{r,echo=FALSE}
  ...
  ggsave(si_plot,file="figures//figure4.png",width=5.5,height=3.25)
  ggsave(si_plot,file="submission to IJE//figure4.png",width=175,height=95,unit="mm") # for IJBNPA
```
...
names(wave.labs)<-c("wave 1","wave 2")
  ...
  ggsave(figure1,file="figures//figure1.png",width=6,height=4)
  ggsave(figure1,file="submission to IJE//figure1.png",width=175,height=100,unit="mm")
```
...
```{r,echo=FALSE,warning=FALSE}
  ...
  figure2
  ggsave(figure2,file="figure2.png",width=6,height=4)
  ggsave(figure2,file="submission to IJE//figure2.png",width=175,height=120,unit="mm")
```
...
em_figures<-grid.arrange(income_Plot.HandPick,
            ...
            heights=c(1),
            nrow=1)
ggsave(em_figures,file="figures//figure3.png",width=175,height=85,units="mm")
ggsave(em_figures,file="submission to IJE//figure3.png",width=175,height=85,units="mm")
```
...
```{r,warning=FALSE}
  si_all_cov_fully<-glmer.nb(mean_mvpa_sd~ stringencyIndex + wear + city_id + 
                          ...
                          employment + 
                          (1|interact_id),
                          data=sd_valid[sd_valid$gender!="other" & sd_valid$age_cat!="missing" &
                                     sd_valid$wave_id=="wave 2",])
```
